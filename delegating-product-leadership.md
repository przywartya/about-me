If you're a founder, chances are you're not just [the guardian of code](https://github.com/przywartya/about-me/edit/main/autonomous-team.md). You're also the product person. You're reviewing PRs not only for correctness but for whether this is even the right solution for the user. You're making business decisions and product decisions at the same time.
